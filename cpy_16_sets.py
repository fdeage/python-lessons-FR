...
#  NNN  NNNNNN        SSSS   III    Cours Python - 1ère - v.3.2                #
#  NNN   NNNNN  SSSS  SSSS   III                                               #
#  NNN    NNNN   SSSSSSSS   IIIII                                              #
#                                                                              #
################################################################################
#               #                                                              #
#  Part. XVI    #  types construits IV : ensembles                             #
#               #                                                              #
################################################################################
...
#   4. On enlève un élément avec la méthode .remove()
...
# méthode .discard()
un_ensemble.discard(37)  # => rien ne se passe

# HP : on peut itérer sur les valeurs d'un set comme n'importe quel itérable
for x in un_ensemble:
    print(x)

# HP : enfin on utilise la méthode .clear() pour vider le set
un_ensemble.clear()
un_ensemble   # => {}

# HP : on unit un ensemble à un autre avec .union()
set1 = {"1", "2" , "3"}
set2 = {1, 2, 3}
