...
################################################################################
#               #                                                              #
#  Part. IX     #  fonctions II                                                #
#               #                                                              #
################################################################################

#############################################
# 15. Fonctions II : retourner une valeur   #
#############################################
#
#  - Le mot-clé "return"
#  - La valeur None
...
def retour_multiple_1(parametre):
    ...
    valeur2 = parametre + 8
    valeur3 = parametre / 3
    return (valeur1, valeur2, valeur3)  # Ceci est un p-uplet
...
def retour_multiple_2(parametre):
    ...
    return valeur1, valeur2  # => les parenthèses autour du p-uplet sont optionnelles
