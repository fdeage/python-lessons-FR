...
#  - HP : arguments vs paramètres
#  - HP : l'adresse d'une fonction
#
#########################################################
...
"""
La fonction est un des deux concepts absolument essentiels pour structurer un
