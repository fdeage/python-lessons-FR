...
###############################################################
# 9. Booléens : valeurs, opérateurs, expressions              #
###############################################################
#
#  - Valeurs booléennes
...
#  - HP : calculs avec les booléens et conversions
#  - HP : all() et any()
#
###############################################################
...
"""
HP : on appelle "or" et "and" des "opérateurs coupe-circuit" ("short circuit
...
"""
Ces deux fonctions opèrent sur des listes (chap. 16).
