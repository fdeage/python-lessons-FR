...
################################################################################
#               #                                                              #
#  Part. XII    #  types construits III : dictionnaires                        #
#               #                                                              #
################################################################################
...
| ------------------------------ | ---------- | ------------------- |
| nombre de valeurs              | variable   | fixe                |
...
dict_vide.get("?")             # => None
# HP : .get() peut prendre une valeur par défaut
...
"""
HP : ces trois méthodes proposent une vue "dynamique" des dictionnaires.
