...
################################################################################
#               #                                                              #
#  Part. X      #  types construits I : listes                                 #
#               #                                                              #
################################################################################
...
Les principaux types construits de Python sont :
    - les listes (chap. 16),
    - les p-uplets, ou tuples (chap. 17),
...
#  - Matrices
#  - Tri de listes
#  - HP : d'autres méthodes sur les listes
#  - HP : les slices
#  - HP : bonus sur les listes
#
###########################################
...
# HP : l'accès au dernier élément peut aussi se faire "par la fin" avec "-n"
...
# HP : on inverse une liste sur place avec .reverse()
desordre.reverse()
